      ...
      <div className="hidden lg:flex flex-1 gradient-bg items-center justify-center p-12 relative overflow-hidden">
        ...
        >
          ...
          <p className="opacity-80 leading-relaxed">
            Access thousands of premium digital products, tools, and services.
            Join our growing community of creators and businesses.
          </p>
        </motion.div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm mb-8">
            {isRegister
              ? "Start your journey with Skilled Zone"
            ...
            {isRegister && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-lg bg-muted/50 border border-border text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 transition-all"
                />
              </div>
            )}
            <div className="relative">
